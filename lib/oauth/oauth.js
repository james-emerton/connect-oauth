...
var OAuth = exports.OAuth = function OAuth(options) {
    ...
    this.use(authorize_url, function(req, resp, next) {
        if(req.method == 'POST')
            self.authorizeToken(req, resp, next);
        else
            authenticate_provider(req, resp, next);
    });
...
**/
OAuth.prototype.authorizeToken = function(req, res, next) {
    var params = req.body,
...
OAuth.prototype.handleError = function(err, req, resp, next) {
    var headers = {
