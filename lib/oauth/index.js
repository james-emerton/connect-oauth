...
var OAuth = exports.OAuth = function OAuth(options) {
    ...
    var plugin = this,
        ...
        protocol = options.protocol
            || realm.protocol.substr(0, realm.protocol.length-1),
    ...
    // Initialize the connect.HTTPServer subclass...
...
util.inherits(OAuth, connect.HTTPServer);
